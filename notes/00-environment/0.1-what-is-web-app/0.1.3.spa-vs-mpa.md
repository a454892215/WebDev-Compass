...
👉 [0.1.3.spa-vs-mpa-demo.html](../../../examples/00-environment/0.1-what-is-web-app/0.1.3.spa-vs-mpa-demo.html)
...
- 上一节：[0.1.2 浏览器的角色](./0.1.2.browser-role.md)
- 下一节：[0.1.4 同源策略与跨域](./0.1.4.same-origin-policy.md)
