...
- **按阶段学习**：从 [01-foundation](./knowledge-map/01-foundation-stages-0-2.md) 开始，逐分册、逐阶段推进；每完成一项可在 `[ ]` 中打勾为 `[x]`。
- **分册阅读**：完整知识点清单拆分为 [6 个分册](./knowledge-map/)（按学习层级），总览见下方「分册目录」。
...
| 序号 | 分册 | 涵盖阶段 | 篇幅 |
| --- | --- | --- | --- |
| 1 | [阶段 0–2：基础层](./knowledge-map/01-foundation-stages-0-2.md) | 阶段 0–2 | 289 行 |
| 2 | [阶段 3–5：工程层](./knowledge-map/02-engineering-stages-3-5.md) | 阶段 3–5 | 241 行 |
| 3 | [阶段 6–7：应用层](./knowledge-map/03-application-stages-6-7.md) | 阶段 6–7 | 146 行 |
| 4 | [阶段 8–11：架构层](./knowledge-map/04-architecture-stages-8-11.md) | 阶段 8–11 | 275 行 |
| 5 | [阶段 12–14：平台层](./knowledge-map/05-platform-stages-12-14.md) | 阶段 12–14 | 201 行 |
| 6 | [阶段 15：项目整合与附录](./knowledge-map/06-delivery-stages-15-appendix.md) | 阶段 15 | 249 行 |
